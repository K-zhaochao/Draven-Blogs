...
``` java
// 合并目录和文件名为文件全路径
FilenameUtils.concat(String basePath, String fullFilenameToAdd)
...
// 转换分隔符为windows系统分隔符
FilenameUtils.separatorsToWindows(String path)

// 判断文件路径是否相同，非格式化
FilenameUtils.equals(String filename1, String filename2) 

// 判断文件路径是否相同，格式化
FilenameUtils.equalsNormalized(String filename1, String filename2)

// 判断目录下是否包含指定文件或目录
FilenameUtils.directoryContains(String canonicalParent, String canonicalChild)

...
public Result sendCode(String phone, HttpSession session) {  
	...
	stringRedisTemplate.opsForValue()
			.set(LOGIN_CODE_KEY + phone, objectMapper.writeValueAsString(loginForm), LOGIN_CODE_TTL, TimeUnit.MINUTES);
...
![img](/Draven_Note_Images/Pasted%20image%2020260603154531.png)

![img](/Draven_Note_Images/Pasted%20image%2020260603154534.png)
...
![img](/Draven_Note_Images/Pasted%20image%2020260603155626.png)

#### 实现思路：

![img](/Draven_Note_Images/Pasted%20image%2020260603160457.png)

![img](/Draven_Note_Images/Pasted%20image%2020260603160825.png)

#### `String` 和 `Hash` 的存储区别：

![img](/Draven_Note_Images/Pasted%20image%2020260603160833.png)

#### 登录拦截器优化：

![img](/Draven_Note_Images/Pasted%20image%2020260603171618.png)
